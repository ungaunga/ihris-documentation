...
This page contains installation instructions on installing iHRIS version 4.0.21 manually.
...
.. code-block:: bash
    ...
    sudo mkdir -p /var/lib/iHRIS/lib/4.0.21
    cd /var/lib/iHRIS/lib/4.0.21
    sudo wget http://launchpad.net/i2ce/4.0/4.0.21/+download/ihris-suite-4.0.21.tar.bz2
    sudo tar -xjf ihris-suite-4.0.21.tar.bz2
...
Follow the [[iHRIS Manage Installation - 4.0.21|iHRIS Manage Installation]] instructions for iHRIS Manage.

Follow the [[iHRIS Qualify Installation - 4.0.21|iHRIS Qualify Installation]] instructions for iHRIS Qualify.
