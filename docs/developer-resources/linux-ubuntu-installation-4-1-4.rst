...
This page contains installation instructions on installing iHRIS version 4.1.4 manually.
...
.. code-block:: bash
    ...
    sudo mkdir -p /var/lib/iHRIS/lib/4.1.4
    cd /var/lib/iHRIS/lib/4.1.4
    sudo wget http://launchpad.net/i2ce/4.1/4.1.4/+download/ihris-suite-4.1.4.tar.bz2
...
Follow the [[iHRIS Manage Installation - 4.1.4|iHRIS Manage Installation]] instructions for iHRIS Manage.
