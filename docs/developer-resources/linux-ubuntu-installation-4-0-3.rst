...
This page contains installation instructions on installing iHRIS version 4.0.3 manually.
{{otherversions|Linux (Ubuntu) Installation}}

 *Warning:*  This does not work on the newest release of Ubuntu.
...
<source lang="bash">
sudo mkdir -p /var/lib/iHRIS/lib/4.0.3
cd /var/lib/iHRIS/lib
sudo ln -s 4.0.3 4.0
cd /var/lib/iHRIS/lib/4.0.3
sudo wget http://launchpad.net/ihris-manage/4.0/4.0.3/+download/ihris-manage-full-4_0_3.tar.bz2
sudo tar -xjf ihris-manage-full-4_0_3.tar.bz2
</source>
