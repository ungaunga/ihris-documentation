...
==APC==
'''NOTE:''' In a recent install of 12.04 LTS server, the PHP version is 5.5.3 and a buggy version of APCu is being used.  Instead of following the instructions below, try [http://wiki.ihris.org/wiki/Linux_%28Ubuntu%29_Installation_-_Supporting_Software_-_13.10#APCu these]
